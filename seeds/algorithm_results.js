  ...
  return knex('algorithm_results').del()
    .then(() => knex('algorithm_results').insert([{
      ...
      { id: 1,
        ...
        annual_revenue_water_sales: 85000,
        annual_revenue_fees_charged: 40000,
        annual_revenue_subsidies: 15000,
        annual_savings_to_financial_reserves: 1000,
        annual_personnel_costs: 70000,
        annual_operations_costs: 50000,
        annual_debt_costs: 14000 },
